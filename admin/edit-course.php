...
$ret=mysqli_query($con,"update courses set courseCode='$courseCode',courseName='$courseName',courseCredit='$courseCredit',updationDate='$currentTime' where id='$id'");
if($ret)
{
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="coueseCredit" name="coueseCredit" placeholder="Course Credit" value="<?php echo htmlentities($row['courseCredit']);?>" required />
  </div>  
