                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <tbody>
<?php
$sql=mysqli_query($con,"select students.studentName as stName, students.studentRegno as stReg,level.level as lvl, department.department as dpt,
students.pincode as pin, students.creationdate as cd, students.batch as bt  from students 
join department on department.id=students.department
join level on level.id=students.level_id");
$cnt=1;
...
?>
                                        ...
                                        <tr>
                                            <td><?php echo $cnt;?></td>
											<td><?php echo htmlentities($row['stName']);?></td>
                                            <td><?php echo htmlentities($row['stReg']);?></td>
                                            <td><?php echo htmlentities($row['dpt']);?></td>
											<td><?php echo htmlentities($row['bt']);?></td>
...
<a href="edit-student-profile.php?id=<?php echo $row['StudentRegno']?>&pass=update" onClick="return confirm('Are you sure you want to reset password?')">
