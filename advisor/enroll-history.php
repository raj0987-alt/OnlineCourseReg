...
courseenrolls.enrollDate as enrollDate, courses.courseName as courname, advisors.AdvisorId as ai,
syllabuses.courseCode as cd, courses.courseCredit as cr, level.level as lvl, department.department as dept,
 ...
 join advisors on advisors.id=students.advisor
 where advisors.AdvisorId= '" . $_SESSION['tlogin'] . "'
");
$cnt=1;
