...
{
$sql=mysqli_query($con,"SELECT password FROM  advisors where password='".md5($_POST['cpass'])."' && AdvisorId='".$_SESSION['tlogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update advisors set password='".md5($_POST['newpass'])."' where AdvisorId='".$_SESSION['tlogin']."'");
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Adviser Change Password </h1>
                    </div>
                </div>
                <div class="row" >
