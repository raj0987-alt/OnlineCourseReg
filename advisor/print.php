...
if(isset($_GET['status']) && isset($_GET['eid']))
{
	$status = $_GET['status'];
	$eid = $_GET['eid'];

	mysqli_query($con,"UPDATE courseenrolls SET status = '{$status}' WHERE id={$eid}");
                        ...
                        <tr>
                            ...
                            <td>
                               ...
                               <b> Student Reg Date:</b> <?php echo htmlentities($row['studentregdate']);?><br>
                                <b> Student Course Registration Date:</b> <?php echo htmlentities($row['edate']);?><br>
                            </td>
                        </tr>
                    </table>
                </td>
