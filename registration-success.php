...
$query = "select * from courseenrolls where status='approved'";
$result = mysqli_query($con, $query);

/* numeric array *///
//$row = mysqli_fetch_assoc($result);
    while ($row = mysqli_fetch_assoc($result)) {
		$studentRegino =$row["studentRegino"];
		$pincode =$row["pincode"];
		$session =$row["session"];
	...
	mysqli_query($con,"insert into registrationsuccess(studentRegino,pincode,department,session,course,enrollDate) 
values('$studentRegino','$pincode','$department','$session','$course','$enrollDate')");
